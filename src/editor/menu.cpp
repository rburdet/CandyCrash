...
void Menu::displayHelp(){
	...
	std::string aux = 
		...
		"\t 3. Seleccionar la cantidad maxima de jugadores que pueden jugar ese nivel en la casilla \"Max Jug\".\n"
		...
		"\n "
		"Ud puede elegir una imagen de fondo para el tablero, bajo la pestana \"Columnas\" en el selector de archivos indicado por \"Fondo\" ."
		"Tambien puede elegir una imagen de fondo para cada celda, o si quiere, un hueco para esa celda. Para eso tiene que presionar bajo la pestana \"Celdas\" el selector de archivo o el boton \"Hueco\" respectivamente."
		"\n\n\n\n\n"
		"Aclaracion:\n"
