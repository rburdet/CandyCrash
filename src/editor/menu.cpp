...
void Menu::displayHelp(){
	...
	std::string aux = 
		...
		"respectivamente. Cuando se presiona el boton \"Hueco\" sobre un"
		"casillero que ya contiene un hueco, aparecera otro de un color mas "
		"claro signifacando que no existe mas un hueco en esa posicion"
		"\n\n\n\n\n"
		"Aclaracion:\n"
